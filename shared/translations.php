...
function translations_catalog(): array {
  return [
    'de' => [
      ...
      'teacher.students.import_hint' => 'CSV-Export aus Blackbaud (oder ähnlich). Erwartete Spalten: <code>Student First Name</code>, <code>Student Last Name</code>, <code>Birth Date</code>.',
    ...
    'en' => [
      ...
      'teacher.students.import_hint' => 'CSV export from Blackbaud (or similar). Expected columns: <code>Student First Name</code>, <code>Student Last Name</code>, <code>Birth Date</code>.',
