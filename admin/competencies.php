...
function previewCompetencyText(s){return escapeHtml((s??'').toString()).replace(/\[checkbox(?:\:[^\]]*)?\]/gi,'<span class="inline-checkbox-placeholder" title="[checkbox]" aria-label="Checkbox-Platzhalter"></span>').replace(/\[vline\]/gi,'<span class="inline-vline-placeholder" title="[vline]" aria-label="Vertikale Trennlinie"></span>');}
