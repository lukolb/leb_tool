...
\begin{center}
  \LEBTitleIcon\\[1cm]
  {\Huge \textbf{LEB Tool \textendash{} Benutzerhandbuch}}\\[0.2cm]
  {\Large Schritt-für-Schritt Anleitung für Admins, Lehrkräfte und Schüler:innen}\\[0.4cm]
  {\large Lernentwicklungsberichte digital verwalten}\\[0.6cm]
  {\large Zielgruppe: Grundschule · Kollegium · Administration}\\[0.6cm]
  {\large Stand: \HandbuchStand}\\[0.6cm]
  {\large Format: Hybrid \textendash{} vollständiger Text + Screenshot-Platzhalter (Abb.)}\\[0.9cm]
\end{center}
