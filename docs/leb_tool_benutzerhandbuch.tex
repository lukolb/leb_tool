...
\begin{itemize}
  \item \textbf{Template (PDF):} definiert Feldnamen, Seiten und Struktur. Änderungen wirken auf alle zugeordneten Klassen.
  \item \textbf{Felder:} besitzen Typ (Text/Option), Gruppe, Reihenfolge, Seiteninfo und optional eine Optionsliste. Feldnamen können mehrfach vorkommen.
  \item \textbf{Optionslisten:} bestehen aus stabilen Values und änderbaren Labels; bei größeren Änderungen wird eine neue Liste versioniert.
  \item \textbf{Klasse:} Schuljahr, Stufe, Bezeichnung, Template, zugeordnete Lehrkräfte und Schüler:innen bilden den primären Arbeitskontext.
  ...
  \item \textbf{Freigabeprinzip:} Schüler-Eingabe ist standardmäßig gesperrt und wird nur zeitlich begrenzt geöffnet.
  \item \textbf{Exportlogik:} Berichte werden stets aus Template + gespeicherten Daten erzeugt; die PDF ist führend.
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Schüler-Logins:} Ausgabe der Zugangsdaten geschützt verwahren; bei Verlust Passwörter zurücksetzen. \WarnBox{Zugangsdaten nicht per unsichere Kanäle teilen.}
...
\PlaceholderFigure{Abb. 16 – Export im Lehrerbereich}{Platzhalter: Exportbereich mit Einzel- und Klassenexport. Aufnahme: Lehrerbereich → Export.}
...
\PlaceholderFigure{Abb. 17 – Export im Adminbereich}{Platzhalter: Admin-Export mit Filtern (Schuljahr/Klasse) und Start-Button. Aufnahme: Adminbereich → Export.}
