...
\begin{itemize}
  ...
  \item \textbf{Leere Dropdowns:} Optionsliste fehlt oder wurde nicht zugeordnet; prüfen Sie Schrittfolge unter Abschnitt \ref{sec:setup-sequenz}.
  \item \textbf{Schüler sehen keine Felder:} Freigabe wurde nicht gesetzt oder bereits geschlossen.
  \item \textbf{Falsche Seitenzuordnung:} Feldextraktion aus PDF prüfen und ggf. neu ausführen.
  \item \textbf{Optionslisten-Value verändert:} Bestehende Values nicht ändern; stattdessen neue Optionsliste anlegen.
  \item \textbf{Klassenexport leer:} Prüfen, ob Klasse ein Template hat und Nutzerrechte korrekt gesetzt sind.
\end{itemize}
...
\begin{enumerate}
  \item Einloggen unter \url{\textbf{TODO: Lehrer-URL einfügen}}.
